...
export const NODE_CONFIG: Record<NodeType, {
  ...
  spec: {
    label: 'Specification',
    color: 'hsl(var(--node-spec))',
    bgClass: 'bg-sky-50 dark:bg-sky-950/30',
    borderClass: 'border-node-spec',
  ...
  prd: {
    label: 'PRD',
    color: 'hsl(var(--node-prd))',
    bgClass: 'bg-purple-50 dark:bg-purple-950/30',
    borderClass: 'border-node-prd',
  ...
  schema: {
    label: 'Schema',
    color: 'hsl(var(--node-schema))',
    bgClass: 'bg-teal-50 dark:bg-teal-950/30',
    borderClass: 'border-node-schema',
  ...
  prompt: {
    label: 'Prompt',
    color: 'hsl(var(--node-prompt))',
    bgClass: 'bg-emerald-50 dark:bg-emerald-950/30',
    borderClass: 'border-node-prompt',
  ...
  reference: {
    label: 'Reference',
    color: 'hsl(var(--node-reference))',
    bgClass: 'bg-gray-50 dark:bg-gray-950/30',
    borderClass: 'border-node-reference',
...
export const DAGRE_CONFIG = {
  rankdir: 'LR' as const,
  nodesep: 14,    // vertical gap between sibling nodes
  ranksep: 40,    // horizontal gap between hierarchy levels
  marginx: 20,
  marginy: 20,
}
