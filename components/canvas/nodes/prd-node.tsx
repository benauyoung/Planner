...
export const PrdNode = memo(function PrdNode({ id, data }: NodeProps) {
  ...
  const criteria = nodeData.acceptanceCriteria || []
      ...
      <div className="p-3">
        ...
        {description ? (
          ...
          <div className="flex flex-col items-center justify-center py-4 border border-dashed rounded-md text-muted-foreground">
            <ClipboardList className="h-6 w-6 mb-1.5 opacity-50" />
            <span className="text-xs">Click to add requirements</span>
          </div>
        )}
      </div>
