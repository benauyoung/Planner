  ...
  return (
    <section id="how-it-works" className="py-24 bg-muted/50">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl text-foreground mb-4">How it works</h2>
          <p className="text-muted-foreground text-lg">Three steps. Zero friction.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {STEPS.map((s, i) => (
            ...
            >
              <div className="text-6xl text-[hsl(25,60%,58%)]/20 mb-4">{s.number}</div>
              <h3 className="text-xl text-foreground mb-2">{s.title}</h3>
