...
function FooterInner() {
    ...
    const footerLinks = {
        [t(lang, 'footerProduct')]: [
            ...
            { label: t(lang, 'footerHowItWorks'), href: '#hero-prompt' },
            { label: t(lang, 'footerTemplates'), href: '/login' },
        ],
    ...
    const copyright = t(lang, 'footerCopyright').replace('{year}', String(year))
